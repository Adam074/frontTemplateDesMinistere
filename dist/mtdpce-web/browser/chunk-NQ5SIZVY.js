...
// src/app/features/documents/politiques/politiques.component.ts
var _c0 = () => [1, 2, 3, 4, 5, 6];
var _c1 = () => ({ "background-color": "#00843B", "border-color": "#00843B" });
var _c2 = () => ({});
var _forTrack0 = ($index, $item) => $item.id;
function PolitiquesComponent_Conditional_27_For_2_Template(rf, ctx) {
  if (rf & 1) {
...
function PolitiquesComponent_Conditional_27_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "div", 17);
    \u0275\u0275repeaterCreate(1, PolitiquesComponent_Conditional_27_For_2_Template, 4, 0, "div", 19, \u0275\u0275repeaterTrackByIdentity);
    \u0275\u0275elementEnd();
  }
  if (rf & 2) {
    \u0275\u0275advance();
...
function PolitiquesComponent_Conditional_28_For_6_Template(rf, ctx) {
  if (rf & 1) {
    const _r1 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "li", 29);
    \u0275\u0275listener("click", function PolitiquesComponent_Conditional_28_For_6_Template_li_click_0_listener() {
...
function PolitiquesComponent_Conditional_28_Conditional_8_Template(rf, ctx) {
  if (rf & 1) {
...
function PolitiquesComponent_Conditional_28_Conditional_9_For_1_Conditional_11_Template(rf, ctx) {
  if (rf & 1) {
...
function PolitiquesComponent_Conditional_28_Conditional_9_For_1_Conditional_12_Template(rf, ctx) {
  if (rf & 1) {
    const _r6 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "button", 46);
    \u0275\u0275listener("click", function PolitiquesComponent_Conditional_28_Conditional_9_For_1_Conditional_12_Template_button_click_0_listener() {
      \u0275\u0275restoreView(_r6);
      const doc_r5 = \u0275\u0275nextContext().$implicit;
      const ctx_r2 = \u0275\u0275nextContext(3);
...
function PolitiquesComponent_Conditional_28_Conditional_9_For_1_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275text(10);
    \u0275\u0275elementEnd();
    \u0275\u0275conditionalCreate(11, PolitiquesComponent_Conditional_28_Conditional_9_For_1_Conditional_11_Template, 2, 1, "span");
    \u0275\u0275elementEnd()();
    \u0275\u0275conditionalCreate(12, PolitiquesComponent_Conditional_28_Conditional_9_For_1_Conditional_12_Template, 4, 0, "button", 45);
    \u0275\u0275elementEnd();
  }
  if (rf & 2) {
...
function PolitiquesComponent_Conditional_28_Conditional_9_ng_container_5_Template(rf, ctx) {
  if (rf & 1) {
    const _r7 = \u0275\u0275getCurrentView();
    \u0275\u0275elementContainerStart(0);
    \u0275\u0275elementStart(1, "button", 49);
    \u0275\u0275listener("click", function PolitiquesComponent_Conditional_28_Conditional_9_ng_container_5_Template_button_click_1_listener() {
...
function PolitiquesComponent_Conditional_28_Conditional_9_Template(rf, ctx) {
  if (rf & 1) {
    const _r4 = \u0275\u0275getCurrentView();
    \u0275\u0275repeaterCreate(0, PolitiquesComponent_Conditional_28_Conditional_9_For_1_Template, 13, 4, "div", 33, _forTrack0);
    \u0275\u0275elementStart(2, "div", 34)(3, "button", 35);
    \u0275\u0275listener("click", function PolitiquesComponent_Conditional_28_Conditional_9_Template_button_click_3_listener() {
      \u0275\u0275restoreView(_r4);
      const ctx_r2 = \u0275\u0275nextContext(2);
    ...
    \u0275\u0275elementEnd();
    \u0275\u0275template(5, PolitiquesComponent_Conditional_28_Conditional_9_ng_container_5_Template, 3, 5, "ng-container", 36);
    \u0275\u0275elementStart(6, "button", 35);
    \u0275\u0275listener("click", function PolitiquesComponent_Conditional_28_Conditional_9_Template_button_click_6_listener() {
      \u0275\u0275restoreView(_r4);
      const ctx_r2 = \u0275\u0275nextContext(2);
...
function PolitiquesComponent_Conditional_28_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "div", 18)(1, "div", 23)(2, "h4", 24);
    \u0275\u0275text(3, "Cat\xE9gories");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(4, "ul", 25);
    \u0275\u0275repeaterCreate(5, PolitiquesComponent_Conditional_28_For_6_Template, 2, 3, "li", 26, _forTrack0);
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(7, "div", 27);
    \u0275\u0275conditionalCreate(8, PolitiquesComponent_Conditional_28_Conditional_8_Template, 5, 0, "div", 28)(9, PolitiquesComponent_Conditional_28_Conditional_9_Template, 8, 3);
    \u0275\u0275elementEnd()();
  }
  if (rf & 2) {
...
var PolitiquesComponent = class _PolitiquesComponent {
  apiService;
  http;
  ...
  loadDocuments() {
    ...
    this.apiService.getPublicDocuments(0, 20).subscribe({
      next: (response) => {
        if (response.success) {
          const filteredDocs = response.data.content.filter((doc) => doc.typeDocument === "DOCUMENT POLITIQUE");
  ...
  static \u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _PolitiquesComponent, selectors: [["app-politiques"]], decls: 29, vars: 2, consts: [[1, "bg-gradient-to-br", "from-[#00843B]", "to-[#006B30]", "text-white", "py-16"], [1, "container", "mx-auto", "px-4"], [1, "text-4xl", "font-bold", "mb-4", "text-white"], [1, "text-primary-100", "text-lg", "max-w-2xl", "mb-2"], [1, "text-green-100", "text-sm"], ["routerLink", "/", 1, "hover:text-white"], [1, "mx-2"], ["routerLink", "/ministere/ministre", 1, "hover:text-white"], [1, "text-white"], [1, "py-12", "bg-neutral-50"], [1, "card", "mb-8"], [1, "flex", "flex-col", "md:flex-row", "gap-4"], [1, "flex-1", "relative"], ["fill", "none", "stroke", "currentColor", "viewBox", "0 0 24 24", 1, "absolute", "left-3", "top-1/2", "-translate-y-1/2", "w-5", "h-5", "text-neutral-400"], ["stroke-linecap", "round", "stroke-linejoin", "round", "stroke-width", "2", "d", "M21 21l-6-6m2-5a7 7 0 11-14 0 7 7 0 0114 0z"], ["type", "text", "placeholder", "Rechercher un document...", 1, "input", "pl-10", 3, "ngModelChange", "keyup.enter", "ngModel"], [1, "btn-primary", 2, "background-color", "#006B30", 3, "click"], [1, "grid", "grid-cols-1", "md:grid-cols-2", "lg:grid-cols-3", "gap-6"], [1, "flex", "gap-6", "items-start"], [1, "card", "animate-pulse"], [1, "h-12", "w-12", "bg-neutral-200", "rounded-xl", "mb-4"], [1, "h-5", "bg-neutral-200", "rounded", "w-3/4", "mb-2"], [1, "h-4", "bg-neutral-200", "rounded", "w-1/2"], [1, "w-96", "p-4", "rounded-xl", "border", "border-gray-200", "bg-gray-50"], [1, "font-semibold", "text-gray-700", "mb-4"], [1, "space-y-2"], [1, "px-3", "py-2", "text-gray-800", "rounded-lg", "cursor-pointer", "border", "border-gray-300", "hover:bg-gray-100", "transition-colors", 3, "bg-gray-200"], [1, "flex-1", "bg-white", "rounded-xl", "shadow", "p-4"], [1, "text-center", "py-16"], [1, "px-3", "py-2", "text-gray-800", "rounded-lg", "cursor-pointer", "border", "border-gray-300", "hover:bg-gray-100", "transition-colors", 3, "click"], ["fill", "none", "stroke", "currentColor", "viewBox", "0 0 24 24", 1, "w-16", "h-16", "text-neutral-300", "mx-auto", "mb-4"], ["stroke-linecap", "round", "stroke-linejoin", "round", "stroke-width", "2", "d", "M7 21h10a2 2 0 002-2V9.414a1 1 0 00-.293-.707l-5.414-5.414A1 1 0 0012.586 3H7a2 2 0 00-2 2v14a2 2 0 002 2z"], [1, "text-lg", "font-medium", "text-neutral-700", "mb-2"], [1, "flex", "items-center", "justify-between", "py-3", "border-b", "last:border-b-0"], [1, "flex", "justify-end", "items-center", "mt-2", "px-6", "py-2", "gap-2", "border-t", "border-gray-200", "bg-gray-50", "rounded-b-lg"], [1, "px-3", "py-1", "border", "border-gray-300", "rounded", "hover:bg-gray-100", "disabled:opacity-50", "transition-colors", 3, "click", "disabled"], [4, "ngFor", "ngForOf"], [1, "flex-shrink-0", "w-12", "h-12", "flex", "items-center", "justify-center", "bg-red-100", "rounded-xl"], ["viewBox", "0 0 24 24", "xmlns", "http://www.w3.org/2000/svg", 1, "w-6", "h-6"], ["d", "M6 2H14L18 6V20C18 21.1046 17.1046 22 16 22H6C4.89543 22 4 21.1046 4 20V4C4 2.89543 4.89543 2 6 2Z", "fill", "#E53E3E"], ["d", "M14 2V6H18", "fill", "white"], [1, "flex-1", "px-4", "min-w-0"], [1, "text-sm", "font-semibold", "text-neutral-900", "truncate"], [1, "flex", "items-center", "gap-2", "mt-1", "text-xs", "text-neutral-400"], [1, "badge-primary"], [1, "flex", "items-center", "gap-2", "px-4", "py-2", "bg-red-600", "text-white", "text-sm", "rounded-xl", "hover:bg-red-700", "transition-colors"], [1, "flex", "items-center", "gap-2", "px-4", "py-2", "bg-red-600", "text-white", "text-sm", "rounded-xl", "hover:bg-red-700", "transition-colors", 3, "click"], ["fill", "none", "stroke", "currentColor", "viewBox", "0 0 24 24", 1, "w-4", "h-4"], ["stroke-linecap", "round", "stroke-linejoin", "round", "stroke-width", "2", "d", "M4 16v1a3 3 0 003 3h10a3 3 0 003-3v-1m-4-4l-4 4m0 0l-4-4m4 4V4"], [3, "click", "ngClass", "ngStyle"]], template: function PolitiquesComponent_Template(rf, ctx) {
    if (rf & 1) {
      ...
      \u0275\u0275twoWayListener("ngModelChange", function PolitiquesComponent_Template_input_ngModelChange_24_listener($event) {
        \u0275\u0275twoWayBindingSet(ctx.searchQuery, $event) || (ctx.searchQuery = $event);
        return $event;
      });
      \u0275\u0275listener("keyup.enter", function PolitiquesComponent_Template_input_keyup_enter_24_listener() {
        return ctx.search();
      });
      \u0275\u0275elementEnd()();
      \u0275\u0275elementStart(25, "button", 16);
      \u0275\u0275listener("click", function PolitiquesComponent_Template_button_click_25_listener() {
        return ctx.search();
      });
      \u0275\u0275text(26, "Rechercher");
      \u0275\u0275elementEnd()()();
      \u0275\u0275conditionalCreate(27, PolitiquesComponent_Conditional_27_Template, 3, 1, "div", 17)(28, PolitiquesComponent_Conditional_28_Template, 10, 1, "div", 18);
      \u0275\u0275elementEnd()();
    }
    if (rf & 2) {
      \u0275\u0275advance(24);
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && setClassMetadata(PolitiquesComponent, [{
    type: Component,
    args: [{ selector: "app-politiques", standalone: true, imports: [CommonModule, FormsModule], template: `  <section class="bg-gradient-to-br from-[#00843B] to-[#006B30] text-white py-16">\r
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(PolitiquesComponent, { className: "PolitiquesComponent", filePath: "src/app/features/documents/politiques/politiques.component.ts", lineNumber: 16 });
})();
export {
  PolitiquesComponent
};
//# sourceMappingURL=chunk-NQ5SIZVY.js.map
