...
// src/app/features/admin/article/agenda/agenda.component.ts
...
function AgendaComponent_Conditional_12_Template(rf, ctx) {
  if (rf & 1) {
...
function AgendaComponent_Conditional_13_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "div", 11);
    \u0275\u0275namespaceSVG();
    ...
    \u0275\u0275text(4, "Aucun agenda pour le moment");
    \u0275\u0275elementEnd()();
  }
}
function AgendaComponent_Conditional_14_For_16_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275text(13);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(14, "td", 28)(15, "div", 29)(16, "button", 30);
    \u0275\u0275namespaceSVG();
    \u0275\u0275elementStart(17, "svg", 31);
    \u0275\u0275element(18, "path", 32)(19, "path", 33);
    \u0275\u0275elementEnd()();
    \u0275\u0275namespaceHTML();
    \u0275\u0275elementStart(20, "button", 34);
    \u0275\u0275listener("click", function AgendaComponent_Conditional_14_For_16_Template_button_click_20_listener() {
    ...
    \u0275\u0275elementEnd()();
    \u0275\u0275namespaceHTML();
    \u0275\u0275elementStart(23, "button", 37);
    \u0275\u0275listener("click", function AgendaComponent_Conditional_14_For_16_Template_button_click_23_listener() {
      const article_r3 = \u0275\u0275restoreView(_r2).$implicit;
      const ctx_r3 = \u0275\u0275nextContext(2);
  ...
  if (rf & 2) {
    ...
    \u0275\u0275advance(2);
    \u0275\u0275textInterpolate(article_r3.lieux);
    \u0275\u0275advance(2);
    \u0275\u0275textInterpolate(ctx_r3.formatDate(article_r3.createdAt));
  }
}
function AgendaComponent_Conditional_14_ng_container_20_Template(rf, ctx) {
  if (rf & 1) {
    const _r5 = \u0275\u0275getCurrentView();
    \u0275\u0275elementContainerStart(0);
    \u0275\u0275elementStart(1, "button", 40);
    \u0275\u0275listener("click", function AgendaComponent_Conditional_14_ng_container_20_Template_button_click_1_listener() {
...
function AgendaComponent_Conditional_14_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275repeaterCreate(15, AgendaComponent_Conditional_14_For_16_Template, 26, 7, "tr", null, _forTrack0);
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(17, "div", 21)(18, "button", 22);
    \u0275\u0275listener("click", function AgendaComponent_Conditional_14_Template_button_click_18_listener() {
      \u0275\u0275restoreView(_r1);
    ...
    \u0275\u0275elementEnd();
    \u0275\u0275template(20, AgendaComponent_Conditional_14_ng_container_20_Template, 3, 5, "ng-container", 23);
    \u0275\u0275elementStart(21, "button", 22);
    \u0275\u0275listener("click", function AgendaComponent_Conditional_14_Template_button_click_21_listener() {
      \u0275\u0275restoreView(_r1);
      const ctx_r3 = \u0275\u0275nextContext();
...
function AgendaComponent_Conditional_15_p_14_Template(rf, ctx) {
  if (rf & 1) {
...
function AgendaComponent_Conditional_15_p_26_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "p", 63);
...
function AgendaComponent_Conditional_15_Conditional_61_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275element(0, "div", 62);
  }
}
function AgendaComponent_Conditional_15_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275listener("ngSubmit", function AgendaComponent_Conditional_15_Template_form_ngSubmit_5_listener() {
      \u0275\u0275restoreView(_r7);
      const ctx_r3 = \u0275\u0275nextContext();
    ...
    \u0275\u0275twoWayListener("ngModelChange", function AgendaComponent_Conditional_15_Template_input_ngModelChange_12_listener($event) {
      \u0275\u0275restoreView(_r7);
      const ctx_r3 = \u0275\u0275nextContext();
    ...
    \u0275\u0275elementEnd();
    \u0275\u0275template(14, AgendaComponent_Conditional_15_p_14_Template, 2, 0, "p", 48);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(15, "div")(16, "label", 45);
    \u0275\u0275text(17, "R\xE9sum\xE9");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(18, "textarea", 49);
    \u0275\u0275twoWayListener("ngModelChange", function AgendaComponent_Conditional_15_Template_textarea_ngModelChange_18_listener($event) {
      \u0275\u0275restoreView(_r7);
      const ctx_r3 = \u0275\u0275nextContext();
    ...
    \u0275\u0275text(23, "*");
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(24, "textarea", 50, 2);
    \u0275\u0275twoWayListener("ngModelChange", function AgendaComponent_Conditional_15_Template_textarea_ngModelChange_24_listener($event) {
      \u0275\u0275restoreView(_r7);
      const ctx_r3 = \u0275\u0275nextContext();
    ...
    \u0275\u0275elementEnd();
    \u0275\u0275template(26, AgendaComponent_Conditional_15_p_26_Template, 2, 0, "p", 48);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(27, "div", 51)(28, "div")(29, "label", 45);
    \u0275\u0275text(30, "Date");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(31, "input", 52);
    \u0275\u0275twoWayListener("ngModelChange", function AgendaComponent_Conditional_15_Template_input_ngModelChange_31_listener($event) {
      \u0275\u0275restoreView(_r7);
      const ctx_r3 = \u0275\u0275nextContext();
      \u0275\u0275twoWayBindingSet(ctx_r3.form.datePublication, $event) || (ctx_r3.form.datePublication = $event);
      return \u0275\u0275resetView($event);
    });
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(32, "div")(33, "label", 45);
    \u0275\u0275text(34, "Lieu");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(35, "input", 47, 1);
    \u0275\u0275twoWayListener("ngModelChange", function AgendaComponent_Conditional_15_Template_input_ngModelChange_35_listener($event) {
      \u0275\u0275restoreView(_r7);
      const ctx_r3 = \u0275\u0275nextContext();
      \u0275\u0275twoWayBindingSet(ctx_r3.form.lieux, $event) || (ctx_r3.form.lieux = $event);
      return \u0275\u0275resetView($event);
    });
    \u0275\u0275elementEnd()()();
    \u0275\u0275elementStart(37, "div")(38, "label", 45);
    \u0275\u0275text(39, "Statut");
    \u0275\u0275elementStart(40, "span", 46);
    \u0275\u0275text(41, "*");
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(42, "select", 53);
    \u0275\u0275twoWayListener("ngModelChange", function AgendaComponent_Conditional_15_Template_select_ngModelChange_42_listener($event) {
      \u0275\u0275restoreView(_r7);
      const ctx_r3 = \u0275\u0275nextContext();
    ...
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(47, "option", 56);
    \u0275\u0275text(48, "Publi\xE9");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(49, "option", 57);
    \u0275\u0275text(50, "Archiv\xE9");
    \u0275\u0275elementEnd()()();
    \u0275\u0275elementStart(51, "div")(52, "label", 45);
    \u0275\u0275text(53, "Image mise en avant ");
    \u0275\u0275elementStart(54, "span", 46);
    \u0275\u0275text(55, "*");
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(56, "input", 58);
    \u0275\u0275listener("change", function AgendaComponent_Conditional_15_Template_input_change_56_listener($event) {
      \u0275\u0275restoreView(_r7);
      const ctx_r3 = \u0275\u0275nextContext();
      return \u0275\u0275resetView(ctx_r3.onFileSelected($event));
    });
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(57, "div", 59)(58, "button", 60);
    \u0275\u0275listener("click", function AgendaComponent_Conditional_15_Template_button_click_58_listener() {
      \u0275\u0275restoreView(_r7);
      const ctx_r3 = \u0275\u0275nextContext();
    ...
    \u0275\u0275text(59, "Annuler");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(60, "button", 61);
    \u0275\u0275conditionalCreate(61, AgendaComponent_Conditional_15_Conditional_61_Template, 1, 0, "div", 62);
    \u0275\u0275text(62);
    \u0275\u0275elementEnd()()()()();
  }
  if (rf & 2) {
    const title_r8 = \u0275\u0275reference(13);
    const content_r9 = \u0275\u0275reference(25);
    const ctx_r3 = \u0275\u0275nextContext();
    \u0275\u0275advance(4);
    \u0275\u0275textInterpolate1(" ", ctx_r3.editingArticle() ? "Modifier l'agenda" : "Nouvel agenda", " ");
    \u0275\u0275advance(8);
    ...
    \u0275\u0275advance(5);
    \u0275\u0275twoWayProperty("ngModel", ctx_r3.form.datePublication);
    \u0275\u0275advance(4);
    \u0275\u0275twoWayProperty("ngModel", ctx_r3.form.lieux);
    \u0275\u0275advance(7);
...
function AgendaComponent_Conditional_16__svg_svg_2_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275namespaceSVG();
...
function AgendaComponent_Conditional_16__svg_svg_3_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275namespaceSVG();
    \u0275\u0275elementStart(0, "svg", 67);
    \u0275\u0275element(1, "path", 69);
...
function AgendaComponent_Conditional_16__svg_svg_4_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275namespaceSVG();
    \u0275\u0275elementStart(0, "svg", 67);
    \u0275\u0275element(1, "path", 70);
...
function AgendaComponent_Conditional_16_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "div", 14)(1, "div", 64);
    \u0275\u0275template(2, AgendaComponent_Conditional_16__svg_svg_2_Template, 2, 0, "svg", 65)(3, AgendaComponent_Conditional_16__svg_svg_3_Template, 2, 0, "svg", 65)(4, AgendaComponent_Conditional_16__svg_svg_4_Template, 2, 0, "svg", 65);
...
function AgendaComponent_Conditional_17_Template(rf, ctx) {
  if (rf & 1) {
    const _r10 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "div", 15)(1, "div", 71)(2, "h3", 72);
    ...
    \u0275\u0275listener("click", function AgendaComponent_Conditional_17_Template_button_click_7_listener() {
      \u0275\u0275restoreView(_r10);
      const ctx_r3 = \u0275\u0275nextContext();
    ...
    \u0275\u0275listener("click", function AgendaComponent_Conditional_17_Template_button_click_9_listener() {
      \u0275\u0275restoreView(_r10);
      const ctx_r3 = \u0275\u0275nextContext();
...
var AgendaComponent = class _AgendaComponent {
  ...
  form = {
    ...
    content: "",
    lieux: "",
    datePublication: /* @__PURE__ */ new Date(),
  ...
  saveArticle(form) {
    ...
    const request = editing ? this.apiService.updateAgendas(editing.id, formData) : this.apiService.createAgendas(formData);
    request.subscribe({
      next: () => {
        this.loadArticles();
  ...
  static \u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _AgendaComponent, selectors: [["app-agenda"]], decls: 18, vars: 4, consts: [["articleForm", "ngForm"], ["title", "ngModel"], ["content", "ngModel"], [1, "space-y-6"], [1, "flex", "flex-col", "sm:flex-row", "sm:items-center", "sm:justify-between", "gap-4"], [1, "text-2xl", "font-bold", "text-neutral-900"], [1, "text-neutral-500"], [1, "btn-primary", 2, "background-color", "#00843B", 3, "click"], ["fill", "none", "stroke", "currentColor", "viewBox", "0 0 24 24", 1, "w-5", "h-5", "mr-2"], ["stroke-linecap", "round", "stroke-linejoin", "round", "stroke-width", "2", "d", "M12 6v6m0 0v6m0-6h6m-6 0H6"], [1, "card", "p-0"], [1, "p-8", "text-center"], [1, "table-container"], [1, "fixed", "inset-0", "bg-black/50", "flex", "items-center", "justify-center", "z-50", "p-4"], [1, "fixed", "top-4", "right-4", "z-50", "pointer-events-none"], [1, "fixed", "inset-0", "bg-black/30", "flex", "items-center", "justify-center", "z-50", "p-4"], [1, "spinner", "w-8", "h-8", "mx-auto"], ["fill", "none", "stroke", "currentColor", "viewBox", "0 0 24 24", 1, "w-12", "h-12", "text-neutral-300", "mx-auto", "mb-4"], ["stroke-linecap", "round", "stroke-linejoin", "round", "stroke-width", "2", "d", "M19 20H5a2 2 0 01-2-2V6a2 2 0 012-2h10a2 2 0 012 2v1m2 13a2 2 0 01-2-2V7m2 13a2 2 0 002-2V9a2 2 0 00-2-2h-2m-4-3H9M7 16h6M7 8h6v4H7V8z"], [1, "table"], [1, "text-right"], [1, "flex", "justify-end", "items-center", "mt-2", "px-6", "py-2", "gap-2", "border-t", "border-gray-200", "bg-gray-50", "rounded-b-lg"], [1, "px-3", "py-1", "border", "border-gray-300", "rounded", "hover:bg-gray-100", "disabled:opacity-50", "transition-colors", 3, "click", "disabled"], [4, "ngFor", "ngForOf"], [1, "max-w-xs"], [1, "font-medium", "text-neutral-900", "truncate"], [1, "text-xs", "text-neutral-400", "truncate"], [1, "text-sm", "text-neutral-500"], [1, "px-6", "py-4", "text-right"], [1, "flex", "justify-end", "gap-2"], ["title", "Voir l'article", 1, "flex", "items-center", "justify-center", "p-2", "border-2", "border-blue-500", "rounded-full", "bg-white", "hover:bg-blue-50", "transition-colors"], ["fill", "none", "stroke", "currentColor", "viewBox", "0 0 24 24", 1, "w-4", "h-4", "text-blue-500"], ["stroke-linecap", "round", "stroke-linejoin", "round", "stroke-width", "2", "d", "M15 12a3 3 0 11-6 0 3 3 0 016 0z"], ["stroke-linecap", "round", "stroke-linejoin", "round", "stroke-width", "2", "d", "M2.458 12C3.732 7.943 7.523 5 12 5c4.477 0 8.268 2.943 9.542 7-1.274 4.057-5.065 7-9.542 7-4.477 0-8.268-2.943-9.542-7z"], ["title", "Modifier", 1, "flex", "items-center", "justify-center", "p-2", "border-2", "border-green-500", "rounded-full", "bg-white", "hover:bg-green-50", "transition-colors", 3, "click"], ["fill", "none", "stroke", "currentColor", "viewBox", "0 0 24 24", 1, "w-4", "h-4", "text-green-500"], ["stroke-linecap", "round", "stroke-linejoin", "round", "stroke-width", "2", "d", "M11 5H6a2 2 0 00-2 2v11a2 2 0 002 2h11a2 2 0 002-2v-5m-1.414-9.414a2 2 0 112.828 2.828L11.828 15H9v-2.828l8.586-8.586z"], ["title", "Supprimer", 1, "flex", "items-center", "justify-center", "p-2", "border-2", "border-red-500", "rounded-full", "bg-white", "hover:bg-red-50", "transition-colors", 3, "click"], ["fill", "none", "stroke", "currentColor", "viewBox", "0 0 24 24", 1, "w-4", "h-4", "text-red-500"], ["stroke-linecap", "round", "stroke-linejoin", "round", "stroke-width", "2", "d", "M19 7l-.867 12.142A2 2 0 0116.138 21H7.862a2 2 0 01-1.995-1.858L5 7m5 4v6m4-6v6m1-10V4a1 1 0 00-1-1h-4a1 1 0 00-1 1v3M4 7h16"], [3, "click", "ngClass", "ngStyle"], [1, "bg-white", "rounded-2xl", "shadow-xl", "w-full", "max-w-2xl", "max-h-[90vh]", "overflow-y-auto"], [1, "p-6", "border-b", "border-neutral-200"], [1, "text-xl", "font-semibold", "text-neutral-900"], ["novalidate", "", 1, "p-6", "space-y-5", 3, "ngSubmit"], [1, "label"], [1, "text-red-500"], ["type", "text", "name", "title", "required", "", 1, "input", 3, "ngModelChange", "ngModel"], ["class", "text-sm text-red-500 mt-1", 4, "ngIf"], ["name", "summary", "rows", "2", 1, "input", "resize-none", 3, "ngModelChange", "ngModel"], ["name", "content", "rows", "6", "required", "", 1, "input", "resize-none", 3, "ngModelChange", "ngModel"], [1, "grid", "grid-cols-2", "gap-4"], ["type", "date", "name", "publishedAt", 1, "input", 3, "ngModelChange", "ngModel"], ["name", "status", 1, "input", 3, "ngModelChange", "ngModel"], ["value", "DRAFT"], ["value", "PENDING"], ["value", "PUBLISHED"], ["value", "ARCHIVED"], ["type", "file", "multiple", "", "accept", "image/*", 1, "input", 3, "change"], [1, "flex", "justify-end", "gap-3", "pt-4", "border-t", "border-neutral-200"], ["type", "button", 1, "px-4", "py-2", "rounded-lg", "border", "border-red-500", "text-red-500", "hover:bg-red-50", "transition-colors", "font-medium", 3, "click"], ["type", "submit", 1, "px-4", "py-2", "rounded-lg", "bg-[#00843B]", "text-white", "hover:bg-[#006830]", "transition-colors", "font-medium", "flex", "items-center", "justify-center", "gap-2", 3, "disabled"], [1, "spinner", "w-4", "h-4", "mr-2"], [1, "text-sm", "text-red-500", "mt-1"], [1, "pointer-events-auto", "border-l-4", "rounded-lg", "shadow-lg", "p-6", "max-w-sm", "w-full", "flex", "items-center", "gap-4", "animate-fade-in", 3, "ngClass"], ["class", "w-6 h-6 flex-shrink-0", "fill", "none", "stroke", "currentColor", "viewBox", "0 0 24 24", 4, "ngIf"], [1, "text-sm", "font-medium"], ["fill", "none", "stroke", "currentColor", "viewBox", "0 0 24 24", 1, "w-6", "h-6", "flex-shrink-0"], ["stroke-linecap", "round", "stroke-linejoin", "round", "stroke-width", "2", "d", "M5 13l4 4L19 7"], ["stroke-linecap", "round", "stroke-linejoin", "round", "stroke-width", "2", "d", "M6 18L18 6M6 6l12 12"], ["stroke-linecap", "round", "stroke-linejoin", "round", "stroke-width", "2", "d", "M13 16h-1v-4h-1m1-4h.01M12 20a8 8 0 100-16 8 8 0 000 16z"], [1, "bg-white", "rounded-2xl", "shadow-xl", "w-full", "max-w-md", "p-6", "space-y-4"], [1, "text-lg", "font-semibold", "text-neutral-900"], [1, "text-neutral-700"], [1, "flex", "justify-end", "gap-3", "mt-4"], [1, "px-4", "py-2", "rounded-lg", "border", "border-gray-300", "text-gray-700", "hover:bg-gray-100", "transition-colors", "font-medium", 3, "click"], [1, "px-4", "py-2", "rounded-lg", "bg-red-600", "text-white", "hover:bg-red-700", "transition-colors", "font-medium", 3, "click"]], template: function AgendaComponent_Template(rf, ctx) {
    if (rf & 1) {
      ...
      \u0275\u0275element(9, "path", 9);
      \u0275\u0275elementEnd();
      \u0275\u0275text(10, " Nouvel agenda ");
      \u0275\u0275elementEnd()();
      \u0275\u0275namespaceHTML();
      \u0275\u0275elementStart(11, "div", 10);
      \u0275\u0275conditionalCreate(12, AgendaComponent_Conditional_12_Template, 2, 0, "div", 11)(13, AgendaComponent_Conditional_13_Template, 5, 0, "div", 11)(14, AgendaComponent_Conditional_14_Template, 23, 3, "div", 12);
      \u0275\u0275elementEnd();
      \u0275\u0275conditionalCreate(15, AgendaComponent_Conditional_15_Template, 63, 12, "div", 13);
      \u0275\u0275elementEnd();
      \u0275\u0275conditionalCreate(16, AgendaComponent_Conditional_16_Template, 7, 9, "div", 14);
      \u0275\u0275conditionalCreate(17, AgendaComponent_Conditional_17_Template, 11, 1, "div", 15);
    }
    if (rf & 2) {
      \u0275\u0275advance(12);
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && setClassMetadata(AgendaComponent, [{
    type: Component,
    args: [{ selector: "app-agenda", standalone: true, imports: [CommonModule, FormsModule, RouterModule], template: `  <div class="space-y-6">\r
      <!-- Header -->\r
      <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">\r
        <div>\r
          <h1 class="text-2xl font-bold text-neutral-900">Agendas</h1>\r
          <p class="text-neutral-500">G\xE9rez l'agenda du ministre</p>\r
        </div>\r
      ...
      <div class="card p-0">\r
        @if (loading()) {\r
          ...
          <div class="p-8 text-center">\r
            ...
            <p class="text-neutral-500">Aucun agenda pour le moment</p>\r
          </div>\r
        } @else {\r
                ...
                @for (article of articles(); track article.id) {\r
                  <tr>\r
                   ...
                   \r
                    ...
                    <td class="font-medium text-neutral-900 truncate">{{ article.lieux }}</td>\r
        ...
        <div class="fixed inset-0 bg-black/50 flex items-center justify-center z-50 p-4">\r
          <div class="bg-white rounded-2xl shadow-xl w-full max-w-2xl max-h-[90vh] overflow-y-auto">\r
            <div class="p-6 border-b border-neutral-200">\r
              ...
              {{ editingArticle() ? "Modifier l'agenda" : 'Nouvel agenda' }}\r
            </h2>\r
\r
            </div>\r
            \r
...
\r
               <div class="grid grid-cols-2 gap-4">\r
                ...
                <label class="label">Date</label>\r
                 <input \r
                    type="date" \r
                    [(ngModel)]="form.datePublication" \r
                    name="publishedAt" \r
                    class="input">\r
                \r
              </div>\r
...
\r
             ...
             \r
                \r
                <div>\r
                  <label class="label">Statut<span class="text-red-500">*</span></label>\r
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(AgendaComponent, { className: "AgendaComponent", filePath: "src/app/features/admin/article/agenda/agenda.component.ts", lineNumber: 15 });
})();
export {
  AgendaComponent
};
//# sourceMappingURL=chunk-GOMHJWYD.js.map
