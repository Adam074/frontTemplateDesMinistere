...
// src/app/features/agendas/detail-agenda/detail-agenda.component.ts
var _c0 = (a0) => ["/agendas", a0];
var _forTrack0 = ($index, $item) => $item.id;
function DetailAgendaComponent_Conditional_0_Template(rf, ctx) {
  if (rf & 1) {
...
function DetailAgendaComponent_Conditional_1_Conditional_10_Template(rf, ctx) {
  if (rf & 1) {
...
function DetailAgendaComponent_Conditional_1_Conditional_30_Template(rf, ctx) {
  if (rf & 1) {
...
function DetailAgendaComponent_Conditional_1_Conditional_31_For_2_Template(rf, ctx) {
  if (rf & 1) {
  ...
  if (rf & 2) {
    ...
    \u0275\u0275advance();
    \u0275\u0275property("src", ctx_r0.getImageUrl(image_r2.imageUrl), \u0275\u0275sanitizeUrl)("alt", ctx_r0.article().title);
  }
}
function DetailAgendaComponent_Conditional_1_Conditional_31_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "div", 29);
    \u0275\u0275repeaterCreate(1, DetailAgendaComponent_Conditional_1_Conditional_31_For_2_Template, 2, 2, "div", 47, _forTrack0);
    \u0275\u0275elementEnd();
  }
  if (rf & 2) {
    const ctx_r0 = \u0275\u0275nextContext(2);
    \u0275\u0275advance();
    \u0275\u0275repeater(ctx_r0.article().images);
  }
}
function DetailAgendaComponent_Conditional_1_div_51_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275pipe(8, "date");
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(9, "div", 54)(10, "div", 55)(11, "span", 56);
    \u0275\u0275text(12);
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(13, "p", 57);
    \u0275\u0275text(14);
    \u0275\u0275elementEnd()()()();
  }
  if (rf & 2) {
    const agenda_r3 = ctx.$implicit;
    \u0275\u0275advance();
    \u0275\u0275property("routerLink", \u0275\u0275pureFunction1(11, _c0, agenda_r3.id));
    \u0275\u0275advance(3);
    \u0275\u0275textInterpolate(\u0275\u0275pipeBind2(5, 5, agenda_r3.publishedAt, "dd"));
    \u0275\u0275advance(3);
    \u0275\u0275textInterpolate(\u0275\u0275pipeBind2(8, 8, agenda_r3.publishedAt, "MMM"));
    \u0275\u0275advance(5);
    \u0275\u0275textInterpolate1(" ", agenda_r3.title, " ");
    \u0275\u0275advance(2);
    \u0275\u0275textInterpolate1(" ", agenda_r3.summary, " ");
  }
}
function DetailAgendaComponent_Conditional_1_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275text(8, " D\xE9tail Agenda ");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(9, "div", 16);
    \u0275\u0275conditionalCreate(10, DetailAgendaComponent_Conditional_1_Conditional_10_Template, 4, 1, "span", 17);
    ...
    \u0275\u0275elementEnd()()()()();
    \u0275\u0275namespaceHTML();
    \u0275\u0275elementStart(15, "section", 20)(16, "div", 2)(17, "div", 21)(18, "div", 22)(19, "h1", 23);
    \u0275\u0275text(20);
    \u0275\u0275elementEnd();
    \u0275\u0275element(21, "hr", 24);
    \u0275\u0275elementStart(22, "div", 25)(23, "span", 17);
    \u0275\u0275namespaceSVG();
    ...
    \u0275\u0275elementEnd()();
    \u0275\u0275element(29, "hr", 24);
    \u0275\u0275conditionalCreate(30, DetailAgendaComponent_Conditional_1_Conditional_30_Template, 2, 1, "p", 28);
    \u0275\u0275conditionalCreate(31, DetailAgendaComponent_Conditional_1_Conditional_31_Template, 3, 0, "div", 29);
    \u0275\u0275elementStart(32, "article", 30);
    \u0275\u0275element(33, "div", 31);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(34, "div", 32)(35, "h3", 33);
    \u0275\u0275text(36, "Partager cet article");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(37, "div", 34)(38, "button", 35);
    \u0275\u0275namespaceSVG();
    \u0275\u0275elementStart(39, "svg", 36);
    \u0275\u0275element(40, "path", 37);
    \u0275\u0275elementEnd()();
    \u0275\u0275namespaceHTML();
    \u0275\u0275elementStart(41, "button", 38);
    \u0275\u0275namespaceSVG();
    \u0275\u0275elementStart(42, "svg", 36);
    \u0275\u0275element(43, "path", 39);
    \u0275\u0275elementEnd()();
    \u0275\u0275namespaceHTML();
    \u0275\u0275elementStart(44, "button", 40);
    \u0275\u0275namespaceSVG();
    \u0275\u0275elementStart(45, "svg", 36);
    \u0275\u0275element(46, "path", 41);
    \u0275\u0275elementEnd()()()()();
    \u0275\u0275namespaceHTML();
    \u0275\u0275elementStart(47, "aside", 42)(48, "h3", 43);
    \u0275\u0275text(49, "Agenda");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(50, "div", 44);
    \u0275\u0275template(51, DetailAgendaComponent_Conditional_1_div_51_Template, 15, 13, "div", 45);
    \u0275\u0275elementEnd()()()()();
  }
  if (rf & 2) {
    let tmp_7_0;
    ...
    \u0275\u0275textInterpolate1(" ", ctx_r0.formatDate(ctx_r0.article().publishedAt || ctx_r0.article().createdAt), " ");
    \u0275\u0275advance(2);
    \u0275\u0275textInterpolate1(" ", ctx_r0.getStatusLabel(ctx_r0.article().status), " ");
    \u0275\u0275advance(2);
    \u0275\u0275conditional(ctx_r0.article().summary ? 30 : -1);
    \u0275\u0275advance();
    \u0275\u0275conditional(((tmp_7_0 = ctx_r0.article()) == null ? null : tmp_7_0.images == null ? null : tmp_7_0.images.length) ? 31 : -1);
    \u0275\u0275advance(2);
...
function DetailAgendaComponent_Conditional_2_Template(rf, ctx) {
  if (rf & 1) {
...
var DetailAgendaComponent = class _DetailAgendaComponent {
  route;
  apiService;
  ...
  static \u0275fac = function DetailAgendaComponent_Factory(__ngFactoryType__) {
    return new (__ngFactoryType__ || _DetailAgendaComponent)(\u0275\u0275directiveInject(ActivatedRoute), \u0275\u0275directiveInject(ApiService));
  };
  static \u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _DetailAgendaComponent, selectors: [["app-detail-agenda"]], decls: 3, vars: 1, consts: [[1, "py-20"], [1, "py-20", "text-center"], [1, "container", "mx-auto", "px-4"], [1, "max-w-3xl", "mx-auto", "animate-pulse"], [1, "h-8", "bg-neutral-200", "rounded", "w-1/4", "mb-4"], [1, "h-12", "bg-neutral-200", "rounded", "w-3/4", "mb-6"], [1, "h-64", "bg-neutral-200", "rounded-xl", "mb-8"], [1, "space-y-4"], [1, "h-4", "bg-neutral-200", "rounded", "w-full"], [1, "h-4", "bg-neutral-200", "rounded", "w-2/3"], [1, "bg-gradient-to-br", "from-[#00843B]", "to-[#006B30]", "text-white", "py-12"], [1, "max-w-3xl"], ["routerLink", "/agendas", 1, "inline-flex", "items-center", "text-white/70", "hover:text-white", "mb-4", "transition-colors", "font-medium"], ["fill", "none", "stroke", "currentColor", "viewBox", "0 0 24 24", 1, "w-4", "h-4", "mr-2"], ["stroke-linecap", "round", "stroke-linejoin", "round", "stroke-width", "2", "d", "M10 19l-7-7m0 0l7-7m-7 7h18"], [1, "text-3xl", "lg:text-4xl", "font-bold", "mb-4", "text-white"], [1, "flex", "flex-wrap", "items-center", "gap-4", "text-white/80", "text-sm"], [1, "flex", "items-center", "gap-1"], ["fill", "none", "stroke", "currentColor", "viewBox", "0 0 24 24", 1, "w-4", "h-4"], ["stroke-linecap", "round", "stroke-linejoin", "round", "stroke-width", "2", "d", "M8 7V3m8 4V3m-9 8h10M5 21h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v12a2 2 0 002 2z"], [1, "py-12", "bg-neutral-50"], [1, "grid", "grid-cols-1", "lg:grid-cols-3", "gap-8"], [1, "lg:col-span-2", "space-y-6"], [1, "text-3xl", "lg:text-4xl", "font-bold", "text-black", "leading-tight"], [1, "border-t-2", "border-gray-300", "my-2"], [1, "flex", "items-center", "gap-4", "text-sm", "text-neutral-500", "mb-2"], ["fill", "none", "stroke", "currentColor", "viewBox", "0 0 24 24", 1, "w-4", "h-4", "inline-block"], [1, "px-2", "py-0.5", "bg-[#00843B]/10", "text-[#00843B]", "font-semibold", "rounded-full"], [1, "text-black", "text-lg", "leading-relaxed", "text-justify", "mb-6"], [1, "space-y-6", "mb-6"], [1, "max-w-none", "text-black", "content-article", "text-base", "leading-relaxed", "text-justify"], [3, "innerHTML"], [1, "mt-12", "pt-8", "border-t", "border-neutral-200"], [1, "text-lg", "font-semibold", "text-neutral-900", "mb-4"], [1, "flex", "gap-3"], [1, "w-10", "h-10", "flex", "items-center", "justify-center", "rounded-full", "bg-[#1DA1F2]", "hover:opacity-80", "transition"], ["fill", "currentColor", "viewBox", "0 0 24 24", 1, "w-5", "h-5", "text-white"], ["d", "M24 4.557c-.883.392-1.832.656-2.828.775 1.017-.609 1.798-1.574 2.165-2.724-.951.564-2.005.974-3.127 1.195-.897-.957-2.178-1.555-3.594-1.555-3.179 0-5.515 2.966-4.797 6.045-4.091-.205-7.719-2.165-10.148-5.144-1.29 2.213-.669 5.108 1.523 6.574-.806-.026-1.566-.247-2.229-.616-.054 2.281 1.581 4.415 3.949 4.89-.693.188-1.452.232-2.224.084.626 1.956 2.444 3.379 4.6 3.419-2.07 1.623-4.678 2.348-7.29 2.04 2.179 1.397 4.768 2.212 7.548 2.212 9.142 0 14.307-7.721 13.995-14.646.962-.695 1.797-1.562 2.457-2.549z"], [1, "w-10", "h-10", "flex", "items-center", "justify-center", "rounded-full", "bg-[#1877F2]", "hover:opacity-80", "transition"], ["d", "M9 8h-3v4h3v12h5v-12h3.642l.358-4h-4v-1.667c0-.955.192-1.333 1.115-1.333h2.885v-5h-3.808c-3.596 0-5.192 1.583-5.192 4.615v3.385z"], [1, "w-10", "h-10", "flex", "items-center", "justify-center", "rounded-full", "bg-[#0077B5]", "hover:opacity-80", "transition"], ["d", "M19 0h-14c-2.761 0-5 2.239-5 5v14c0 2.761 2.239 5 5 5h14c2.762 0 5-2.239 5-5v-14c0-2.761-2.238-5-5-5zm-11 19h-3v-11h3v11zm-1.5-12.268c-.966 0-1.75-.79-1.75-1.764s.784-1.764 1.75-1.764 1.75.79 1.75 1.764-.783 1.764-1.75 1.764zm13.5 12.268h-3v-5.604c0-3.368-4-3.113-4 0v5.604h-3v-11h3v1.765c1.396-2.586 7-2.777 7 2.476v6.759z"], [1, "space-y-6", "bg-gray-100", "p-6", "rounded-xl"], [1, "text-xl", "font-bold", "text-neutral-900", "mb-4"], [1, "flex", "flex-col", "justify-between", "space-y-6"], ["class", "bg-white rounded-2xl p-6 shadow-lg hover:shadow-2xl transition-shadow cursor-pointer group", 4, "ngFor", "ngForOf"], ["stroke-linecap", "round", "stroke-linejoin", "round", "stroke-width", "2", "d", "M16 7a4 4 0 11-8 0 4 4 0 018 0zM12 14a7 7 0 00-7 7h14a7 7 0 00-7-7z"], [1, "rounded-xl", "overflow-hidden", "shadow-lg", "bg-white", "w-full"], [1, "w-full", "h-auto", 3, "src", "alt"], [1, "bg-white", "rounded-2xl", "p-6", "shadow-lg", "hover:shadow-2xl", "transition-shadow", "cursor-pointer", "group"], [1, "flex", "items-center", "gap-4", 3, "routerLink"], [1, "flex-shrink-0", "w-16", "h-16", "rounded-full", "flex", "flex-col", "items-center", "justify-center", "bg-[rgb(231,76,60)]", "text-white", "font-bold", "text-sm"], [1, "text-lg"], [1, "text-xs", "uppercase"], [1, "flex-1"], [1, "flex", "justify-between", "items-center", "mb-2"], [1, "text-sm", "font-medium", "text-[rgb(231,76,60)]"], [1, "text-slate-700", "font-medium", "line-clamp-2"], ["fill", "none", "stroke", "currentColor", "viewBox", "0 0 24 24", 1, "w-16", "h-16", "text-neutral-300", "mx-auto", "mb-4"], ["stroke-linecap", "round", "stroke-linejoin", "round", "stroke-width", "2", "d", "M9.172 16.172a4 4 0 015.656 0M9 10h.01M15 10h.01M21 12a9 9 0 11-18 0 9 9 0 0118 0z"], [1, "text-xl", "font-semibold", "text-neutral-700", "mb-2"], [1, "text-neutral-500", "mb-6"], ["routerLink", "/articles", 1, "btn-primary"]], template: function DetailAgendaComponent_Template(rf, ctx) {
    if (rf & 1) {
      \u0275\u0275conditionalCreate(0, DetailAgendaComponent_Conditional_0_Template, 10, 0, "div", 0)(1, DetailAgendaComponent_Conditional_1_Template, 52, 9)(2, DetailAgendaComponent_Conditional_2_Template, 9, 0, "div", 1);
    }
    if (rf & 2) {
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && setClassMetadata(DetailAgendaComponent, [{
    type: Component,
    args: [{ selector: "app-detail-agenda", standalone: true, imports: [CommonModule, RouterModule], template: `@if (loading()) {\r
      <div class="py-20">\r
...
\r
                ...
                {{ getStatusLabel(article()!.status) }}\r
                </span>\r
            </div>\r
\r
...
\r
            \r
            @if (article()?.images?.length) {\r
            <div class="space-y-6 mb-6">\r
                @for (image of article()!.images; track image.id) {\r
                <div class="rounded-xl overflow-hidden shadow-lg bg-white w-full">\r
                    <img \r
                    [src]="getImageUrl(image.imageUrl)" \r
                    [alt]="article()!.title"\r
                    class="w-full h-auto"\r
                    >\r
                </div>\r
                }\r
            </div>\r
            ...
            @if (article()!.images ) {\r
                ...
                <img [src]="getImageUrl(article()?.images)" [alt]="article()!.title" class="w-full h-auto object-cover">\r
                </div>\r
            } -->\r
\r
...
\r
            ...
            <aside class="space-y-6 bg-gray-100 p-6 rounded-xl">\r
                <h3 class="text-xl font-bold text-neutral-900 mb-4">Agenda</h3>\r
...
\r
                        <div class="flex items-center gap-4" [routerLink]="['/agendas', agenda.id]">\r
\r
                        <!-- Date -->\r
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(DetailAgendaComponent, { className: "DetailAgendaComponent", filePath: "src/app/features/agendas/detail-agenda/detail-agenda.component.ts", lineNumber: 15 });
})();
export {
  DetailAgendaComponent
};
//# sourceMappingURL=chunk-RJ55RLN3.js.map
