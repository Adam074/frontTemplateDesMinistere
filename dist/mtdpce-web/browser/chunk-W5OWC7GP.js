...
var AdminArticlesComponent = class _AdminArticlesComponent {
  ...
  saveArticle() {
    ...
    const request = editing ? this.apiService.updateArticle1(editing.id, this.form) : this.apiService.createArticle1(this.form);
    request.subscribe({
      next: (response) => {
        if (response.success) {
          this.loadArticles();
...
//# sourceMappingURL=chunk-W5OWC7GP.js.map
