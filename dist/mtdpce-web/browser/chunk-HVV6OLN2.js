...
// src/app/features/admin/domains/domains.component.ts
var _c0 = () => [];
...
function DomainsComponent_For_22_Template(rf, ctx) {
  if (rf & 1) {
    const _r1 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "tr", 16)(1, "td", 23)(2, "p", 24);
    \u0275\u0275text(3);
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(4, "td", 25)(5, "div", 26)(6, "button", 27);
    \u0275\u0275listener("click", function DomainsComponent_For_22_Template_button_click_6_listener() {
      const project_r2 = \u0275\u0275restoreView(_r1).$implicit;
      const ctx_r2 = \u0275\u0275nextContext();
      return \u0275\u0275resetView(ctx_r2.editProject(project_r2));
    });
    \u0275\u0275namespaceSVG();
    \u0275\u0275elementStart(7, "svg", 28);
    \u0275\u0275element(8, "path", 29);
    \u0275\u0275elementEnd()();
    \u0275\u0275namespaceHTML();
    \u0275\u0275elementStart(9, "button", 30);
    \u0275\u0275listener("click", function DomainsComponent_For_22_Template_button_click_9_listener() {
      const project_r2 = \u0275\u0275restoreView(_r1).$implicit;
      const ctx_r2 = \u0275\u0275nextContext();
    ...
    \u0275\u0275element(11, "path", 32);
    \u0275\u0275elementEnd()()()()();
  }
  if (rf & 2) {
    const project_r2 = ctx.$implicit;
    \u0275\u0275advance(3);
    \u0275\u0275textInterpolate(project_r2.nom);
  }
}
function DomainsComponent_ng_container_26_Template(rf, ctx) {
  if (rf & 1) {
    const _r4 = \u0275\u0275getCurrentView();
    \u0275\u0275elementContainerStart(0);
    \u0275\u0275elementStart(1, "button", 33);
    \u0275\u0275listener("click", function DomainsComponent_ng_container_26_Template_button_click_1_listener() {
...
function DomainsComponent_Conditional_29_p_14_Template(rf, ctx) {
  if (rf & 1) {
...
function DomainsComponent_Conditional_29_Conditional_19_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275element(0, "div", 45);
  }
}
function DomainsComponent_Conditional_29_Template(rf, ctx) {
  if (rf & 1) {
    const _r6 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "div", 20)(1, "div", 34)(2, "div", 35)(3, "h2", 36);
    \u0275\u0275text(4);
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(5, "form", 37, 0);
    \u0275\u0275listener("ngSubmit", function DomainsComponent_Conditional_29_Template_form_ngSubmit_5_listener() {
      \u0275\u0275restoreView(_r6);
      const ctx_r2 = \u0275\u0275nextContext();
      return \u0275\u0275resetView(ctx_r2.saveProject());
    });
    \u0275\u0275elementStart(7, "div")(8, "label", 38);
    \u0275\u0275text(9, "Nom ");
    \u0275\u0275elementStart(10, "span", 39);
    \u0275\u0275text(11, "*");
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(12, "input", 40, 1);
    \u0275\u0275twoWayListener("ngModelChange", function DomainsComponent_Conditional_29_Template_input_ngModelChange_12_listener($event) {
      \u0275\u0275restoreView(_r6);
      const ctx_r2 = \u0275\u0275nextContext();
    ...
    \u0275\u0275elementEnd();
    \u0275\u0275template(14, DomainsComponent_Conditional_29_p_14_Template, 2, 0, "p", 41);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(15, "div", 42)(16, "button", 43);
    \u0275\u0275listener("click", function DomainsComponent_Conditional_29_Template_button_click_16_listener() {
      \u0275\u0275restoreView(_r6);
      const ctx_r2 = \u0275\u0275nextContext();
    ...
    \u0275\u0275conditionalCreate(19, DomainsComponent_Conditional_29_Conditional_19_Template, 1, 0, "div", 45);
    \u0275\u0275text(20);
    \u0275\u0275elementEnd()()()()();
  }
  if (rf & 2) {
    ...
    \u0275\u0275advance();
    \u0275\u0275conditional(ctx_r2.saving() ? 19 : -1);
    \u0275\u0275advance();
    \u0275\u0275textInterpolate1(" ", ctx_r2.editingProject() ? "Mettre \xE0 jour" : "Enr\xE9gistrer", " ");
  }
}
function DomainsComponent_Conditional_30__svg_svg_2_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275namespaceSVG();
...
function DomainsComponent_Conditional_30__svg_svg_3_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275namespaceSVG();
    \u0275\u0275elementStart(0, "svg", 50);
    \u0275\u0275element(1, "path", 52);
...
function DomainsComponent_Conditional_30__svg_svg_4_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275namespaceSVG();
    \u0275\u0275elementStart(0, "svg", 50);
    \u0275\u0275element(1, "path", 53);
...
function DomainsComponent_Conditional_30_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "div", 21)(1, "div", 47);
    \u0275\u0275template(2, DomainsComponent_Conditional_30__svg_svg_2_Template, 2, 0, "svg", 48)(3, DomainsComponent_Conditional_30__svg_svg_3_Template, 2, 0, "svg", 48)(4, DomainsComponent_Conditional_30__svg_svg_4_Template, 2, 0, "svg", 48);
...
function DomainsComponent_Conditional_31_Template(rf, ctx) {
  if (rf & 1) {
    const _r9 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "div", 22)(1, "div", 54)(2, "h3", 55);
    ...
    \u0275\u0275listener("click", function DomainsComponent_Conditional_31_Template_button_click_7_listener() {
      \u0275\u0275restoreView(_r9);
      const ctx_r2 = \u0275\u0275nextContext();
    ...
    \u0275\u0275listener("click", function DomainsComponent_Conditional_31_Template_button_click_9_listener() {
      \u0275\u0275restoreView(_r9);
      const ctx_r2 = \u0275\u0275nextContext();
...
var DomainsComponent = class _DomainsComponent {
  apiService;
  notification = signal({
    show: false,
    message: "",
  ...
  static \u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _DomainsComponent, selectors: [["app-domains"]], decls: 32, vars: 7, consts: [["projectForm", "ngForm"], ["nameField", "ngModel"], [1, "space-y-6"], [1, "flex", "flex-col", "sm:flex-row", "sm:items-center", "sm:justify-between", "gap-4"], [1, "text-2xl", "font-bold", "text-neutral-900"], [1, "text-neutral-500"], [1, "btn-primary", 2, "background-color", "#00843B", 3, "click"], ["fill", "none", "stroke", "currentColor", "viewBox", "0 0 24 24", 1, "w-5", "h-5", "mr-2"], ["stroke-linecap", "round", "stroke-linejoin", "round", "stroke-width", "2", "d", "M12 6v6m0 0v6m0-6h6m-6 0H6"], [1, "card", "p-0", "shadow-lg", "rounded-lg", "overflow-hidden"], [1, "table-container"], [1, "w-full", "table-auto"], [1, "bg-gray-50"], [1, "px-6", "py-3", "text-left"], [1, "px-6", "py-3", "text-right", "whitespace-nowrap"], [1, "bg-white", "divide-y", "divide-gray-200"], [1, "hover:bg-gray-50", "transition"], [1, "flex", "justify-end", "items-center", "mt-2", "px-6", "py-2", "gap-2", "border-t", "border-gray-200", "bg-gray-50", "rounded-b-lg"], [1, "px-3", "py-1", "border", "border-gray-300", "rounded", "hover:bg-gray-100", "disabled:opacity-50", "transition-colors", 3, "click", "disabled"], [4, "ngFor", "ngForOf"], [1, "fixed", "inset-0", "bg-black/50", "flex", "items-center", "justify-center", "z-50", "p-4"], [1, "fixed", "top-4", "right-4", "z-50", "pointer-events-none"], [1, "fixed", "inset-0", "bg-black/30", "flex", "items-center", "justify-center", "z-50", "p-4"], [1, "px-6", "py-4"], [1, "font-semibold", "text-gray-900", "truncate"], [1, "px-6", "py-4", "text-right", "whitespace-nowrap"], [1, "flex", "justify-end", "gap-2"], ["title", "Modifier", 1, "p-2", "border-2", "border-green-500", "rounded-full", "bg-white", "hover:bg-green-50", "transition", 3, "click"], ["fill", "none", "stroke", "currentColor", "viewBox", "0 0 24 24", 1, "w-4", "h-4", "text-green-500"], ["stroke-linecap", "round", "stroke-linejoin", "round", "stroke-width", "2", "d", "M11 5H6a2 2 0 00-2 2v11a2 2 0 002 2h11a2 2 0 002-2v-5m-1.414-9.414a2 2 0 112.828 2.828L11.828 15H9v-2.828l8.586-8.586z"], ["title", "Supprimer", 1, "p-2", "border-2", "border-red-500", "rounded-full", "bg-white", "hover:bg-red-50", "transition", 3, "click"], ["fill", "none", "stroke", "currentColor", "viewBox", "0 0 24 24", 1, "w-4", "h-4", "text-red-500"], ["stroke-linecap", "round", "stroke-linejoin", "round", "stroke-width", "2", "d", "M19 7l-.867 12.142A2 2 0 0116.138 21H7.862a2 2 0 01-1.995-1.858L5 7m5 4v6m4-6v6m1-10V4a1 1 0 00-1-1h-4a1 1 0 00-1 1v3M4 7h16"], [3, "click", "ngClass", "ngStyle"], [1, "bg-white", "rounded-2xl", "shadow-xl", "w-full", "max-w-2xl", "max-h-[90vh]", "overflow-y-auto"], [1, "p-6", "border-b", "border-neutral-200"], [1, "text-xl", "font-semibold", "text-neutral-900"], [1, "p-6", "space-y-5", 3, "ngSubmit"], [1, "label"], [1, "text-danger-500"], ["type", "text", "name", "nom", "required", "", 1, "input", 3, "ngModelChange", "ngModel"], ["class", "text-sm text-red-500 mt-1", 4, "ngIf"], [1, "flex", "justify-end", "gap-3", "pt-4", "border-t", "border-gray-200"], ["type", "button", 1, "px-4", "py-2", "rounded-lg", "border", "border-red-500", "text-red-500", "hover:bg-red-50", "transition-colors", "font-medium", 3, "click"], ["type", "submit", 1, "px-4", "py-2", "rounded-lg", "bg-[#00843B]", "text-white", "hover:bg-[#006830]", "transition-colors", "font-medium", "flex", "items-center", "justify-center", "gap-2", 3, "disabled"], [1, "spinner", "w-4", "h-4", "border-2", "border-t-white", "border-gray-200", "rounded-full", "animate-spin"], [1, "text-sm", "text-red-500", "mt-1"], [1, "pointer-events-auto", "border-l-4", "rounded-lg", "shadow-lg", "p-6", "max-w-sm", "w-full", "flex", "items-center", "gap-4", "animate-fade-in", 3, "ngClass"], ["class", "w-6 h-6 flex-shrink-0", "fill", "none", "stroke", "currentColor", "viewBox", "0 0 24 24", 4, "ngIf"], [1, "text-sm", "font-medium"], ["fill", "none", "stroke", "currentColor", "viewBox", "0 0 24 24", 1, "w-6", "h-6", "flex-shrink-0"], ["stroke-linecap", "round", "stroke-linejoin", "round", "stroke-width", "2", "d", "M5 13l4 4L19 7"], ["stroke-linecap", "round", "stroke-linejoin", "round", "stroke-width", "2", "d", "M6 18L18 6M6 6l12 12"], ["stroke-linecap", "round", "stroke-linejoin", "round", "stroke-width", "2", "d", "M13 16h-1v-4h-1m1-4h.01M12 20a8 8 0 100-16 8 8 0 000 16z"], [1, "bg-white", "rounded-2xl", "shadow-xl", "w-full", "max-w-md", "p-6", "space-y-4"], [1, "text-lg", "font-semibold", "text-neutral-900"], [1, "text-neutral-700"], [1, "flex", "justify-end", "gap-3", "mt-4"], [1, "px-4", "py-2", "rounded-lg", "border", "border-gray-300", "text-gray-700", "hover:bg-gray-100", "transition-colors", "font-medium", 3, "click"], [1, "px-4", "py-2", "rounded-lg", "bg-red-600", "text-white", "hover:bg-red-700", "transition-colors", "font-medium", 3, "click"]], template: function DomainsComponent_Template(rf, ctx) {
    if (rf & 1) {
      ...
      \u0275\u0275text(19, "Actions");
      \u0275\u0275elementEnd()()();
      \u0275\u0275elementStart(20, "tbody", 15);
      \u0275\u0275repeaterCreate(21, DomainsComponent_For_22_Template, 12, 1, "tr", 16, _forTrack0);
      \u0275\u0275elementEnd()();
      \u0275\u0275elementStart(23, "div", 17)(24, "button", 18);
      \u0275\u0275listener("click", function DomainsComponent_Template_button_click_24_listener() {
        return ctx.prevPage();
      });
      \u0275\u0275text(25, " \xAB Pr\xE9c\xE9dent ");
      \u0275\u0275elementEnd();
      \u0275\u0275template(26, DomainsComponent_ng_container_26_Template, 3, 5, "ng-container", 19);
      \u0275\u0275elementStart(27, "button", 18);
      \u0275\u0275listener("click", function DomainsComponent_Template_button_click_27_listener() {
        return ctx.nextPage();
      });
      \u0275\u0275text(28, " Suivant \xBB ");
      \u0275\u0275elementEnd()()();
      \u0275\u0275conditionalCreate(29, DomainsComponent_Conditional_29_Template, 21, 6, "div", 20);
      \u0275\u0275elementEnd();
      \u0275\u0275conditionalCreate(30, DomainsComponent_Conditional_30_Template, 7, 9, "div", 21);
      \u0275\u0275conditionalCreate(31, DomainsComponent_Conditional_31_Template, 11, 1, "div", 22);
      \u0275\u0275elementEnd();
    }
    if (rf & 2) {
      \u0275\u0275advance(21);
      ...
      \u0275\u0275advance();
      \u0275\u0275conditional(ctx.notification().show ? 30 : -1);
      \u0275\u0275advance();
      \u0275\u0275conditional(ctx.confirmModal().show ? 31 : -1);
    }
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && setClassMetadata(DomainsComponent, [{
    type: Component,
    args: [{ selector: "app-domains", standalone: true, imports: [CommonModule, FormsModule], template: `  <div class="space-y-6">\r
      <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">\r
        <div>\r
          <h1 class="text-2xl font-bold text-neutral-900">Domaines</h1>\r
          <p class="text-neutral-500">G\xE9rez les domaines d'intervention des structures rattach\xE9es</p>\r
        </div>\r
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(DomainsComponent, { className: "DomainsComponent", filePath: "src/app/features/admin/domains/domains.component.ts", lineNumber: 14 });
})();
export {
  DomainsComponent
};
//# sourceMappingURL=chunk-HVV6OLN2.js.map
